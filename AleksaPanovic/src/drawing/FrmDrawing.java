	...
	protected void modify() {
		...
		if (selectedShape != null) {
			...
			if (selectedShape instanceof Point) {
				...
				dialog.getTxtX1().setText("" + Integer.toString(line.getStartpoint().getX()));
				dialog.getTxtY1().setText("" + Integer.toString(line.getStartpoint().getY()));
				dialog.getTxtX2().setText("" + Integer.toString(line.getEndpoint().getX()));
				dialog.getTxtY2().setText("" + Integer.toString(line.getEndpoint().getY()));
